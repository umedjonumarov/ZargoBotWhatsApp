...
11. confirm_order — буюртмани ТЎЛИҚ тасдиқлаш ("тасдиқлайман", "ха буюртмани тасдиқла")
12. proceed — Маҳсулот танлаш тугади, манзилга ўтамиз ("булди", "тамом", "хозирча шу", "етади", "буюртмамни ёзинг", "мен танлаганни бер", "етказинг")
13. cancel_order — бекор қилиш ("бекор қил", "керак эмас")
14. night_order_yes — тунги буюртмага розилик ("ҳа эртанги учун олинг")
15. night_order_no — тунги буюртмадан рад ("йўқ керак эмас")
16. stop_reminders — авто-эслатмаларни тўхтатиш ("хабар юборманг бошқа")
17. ask_question — умумий савол ("ишлаш вақти?", "қаердасиз?")
18. unclear — тушунарсиз
...
```json
{
  ...
  "products": [], "money_products": [],
  "name": null, "address": null, "phone": null,
  "raw_text": "булди хозирча шу"
}
```

Мижоз: "тамом, етказинг"
Жавоб:
```json
{
  "intent": "proceed",
  "products": [], "money_products": [],
  "name": null, "address": null, "phone": null,
  "raw_text": "тамом, етказинг"
}
```

Мижоз: "Мен танлаган махсулотларни бер"
Жавоб:
```json
{
  "intent": "proceed",
  "products": [], "money_products": [],
  "name": null, "address": null, "phone": null,
  "raw_text": "Мен танлаган махсулотларни бер"
}
```
